...
CONFIG = {
    ...
    "test_size": 0.2,
    "mlflow_tracking_uri": "https://dagshub.com/ankajonly/text-sentiment-analysis-mlops.mlflow",
    "dagshub_repo_owner": "ankajonly",
    "dagshub_repo_name": "text-sentiment-analysis-mlops",
